...
export function OjoLogo({ size = "md", dark = false }: { size?: "sm" | "md" | "lg", dark?: boolean }) {
  ...
  const charcoal = dark ? "#FFFFFF" : "#1A1A1A";
  const red = "#C1441A";
  const gold = "#B8860B";
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      >
        ...
        <g transform="translate(0, 45)">
          ...
          <g transform="translate(60, 45)">
            ...
            <circle cx="0" cy="0" r="30" stroke={red} strokeWidth="1.5" />
      ...
      >
        ...
        <span style={{ color: red }}>Trust.</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div className={`inline-flex items-center justify-center ${className}`}>
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="12" cy="12" r="10" fill="#B8860B" fillOpacity="0.1" stroke="#B8860B" strokeWidth="1" />
        <circle cx="12" cy="12" r="6" stroke="#C1441A" strokeWidth="1" />
    ...
    <div className={`relative flex items-center justify-center w-24 h-24 group origin-center ${className}`}>
      <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-sm">
        ...
        <g transform="translate(50, 50)" textAnchor="middle" fontFamily="sans-serif">
          ...
          {/* Divider 1 */}
          <line x1="-15" y1="-20" x2="15" y2="-20" stroke="#B8860B" strokeWidth="0.3" opacity="0.5" />
          <path d="M-1.5 -21.5 L1.5 -18.5 M-1.5 -18.5 L1.5 -21.5" stroke="#B8860B" strokeWidth="0.5" transform="translate(0, 0)" />
          <circle cx="0" cy="-20" r="1.2" fill="#FDF5E6" stroke="#B8860B" strokeWidth="0.3" />
          <circle cx="0" cy="-20" r="0.4" fill="#B8860B" />

          {/* VERIFIED Text */}
          <text y="-5" fontSize="11" fontWeight="900" fill="#1A1A1A" letterSpacing="0.5">VERIFIED</text>
          
          {/* Divider 2 */}
          <line x1="-15" y1="5" x2="15" y2="5" stroke="#B8860B" strokeWidth="0.3" opacity="0.5" />
          <circle cx="0" cy="5" r="1.2" fill="#FDF5E6" stroke="#B8860B" strokeWidth="0.3" />
          <circle cx="0" cy="5" r="0.4" fill="#B8860B" />
          
          {/* AUTHENTIC & TRUSTED text */}
          <text y="18" fontSize="5" fontWeight="800" fill="#1A1A1A" letterSpacing="0.8">AUTHENTIC</text>
          <text y="24" fontSize="5" fontWeight="800" fill="#1A1A1A" letterSpacing="0.8">& TRUSTED</text>
          
          {/* Bottom Motif */}
          <path d="M-2 32 Q0 28 2 32 Q0 36 -2 32" fill="#B8860B" opacity="0.6" transform="translate(0, 0)" />
          <circle cx="0" cy="34" r="0.5" fill="#B8860B" opacity="0.8" />
        </g>
      </svg>
    </div>
  );
